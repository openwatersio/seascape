...
def stage_build(bundle_dir="store/bundle"):
    ...
    baked leaves. coverage.pmtiles and land.pmtiles are catalogs products (this graph never writes
    them); each ships when the warm volume has it, and the Worker tolerates its absence."""
