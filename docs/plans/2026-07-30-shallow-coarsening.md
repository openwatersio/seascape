...
2. **§4b pond fill** — 11.6× parts, the only operator that provably preserves the channel network, shrinks the drying bucket the union pays for, and cuts the resident-ladder size that drives step 1's risk. Gate 6 (named routes) is live for it.
3. **§6a / §6b / §6d** — independent shoal-bias and threshold fixes, each with a gate that already exists.
